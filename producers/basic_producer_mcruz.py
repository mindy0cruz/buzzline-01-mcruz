...
ADJECTIVES = ["amazing", "dominant", "fast-paced", "thrilling", "unbelievable"]
ACTIONS = ["scored", "dunked", "assisted", "blocked", "sprinted"]
TOPICS = ["a three-pointer", "a fast break", "an alley-oop", "a buzzer-beater", "a steal"]
